...
var getYD =function(shopResult , doneCallback){
    ...
    .then(function(result){
        ...
        // console.log(analysisFunc.dishCompare(result))
...
var YDAnalysis = function(shop, doneCallback){
    
        // console.log('begin calc');
        getYD(shop,doneCallback);
        // return doneCallback(null);
    
}
var asyncTask = function(shopList){
    async.eachLimit(shopList,3,YDAnalysis,function(err){
